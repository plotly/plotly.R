...
* The `config()` function gains a `locale` argument for easily changing localization defaults (see #1270). Among other things, this makes it possible to change the language used when hovering over modebar buttons.
